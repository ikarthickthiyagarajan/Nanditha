  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-950 text-cyan-100 relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-40 right-32 w-1 h-1 bg-green-400 rounded-full animate-ping opacity-40" />
        <div className="absolute bottom-32 left-1/4 w-3 h-3 bg-purple-400 rounded-full animate-bounce opacity-50" />
        <div className="absolute bottom-20 right-20 w-2 h-2 bg-pink-400 rounded-full animate-pulse opacity-60" />
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            <div className="w-56 h-56 mx-auto mb-8 relative">
              <div className="w-full h-full bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 rounded-full flex items-center justify-center text-6xl font-bold text-white shadow-2xl shadow-cyan-500/50 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-cyan-400/20 via-transparent to-purple-600/20 animate-pulse" />
                <span className="relative z-10">NG</span>
              </div>
              <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-green-400 to-teal-500 rounded-full flex items-center justify-center animate-pulse shadow-lg shadow-green-500/50">
                <Microscope className="w-10 h-10 text-white" />
              </div>
              <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-gradient-to-br from-pink-400 to-purple-500 rounded-full flex items-center justify-center animate-bounce shadow-lg shadow-pink-500/50">
          ...
          >
            ...
            <div className="flex items-center justify-center space-x-4 text-lg text-green-400">
              ...
              <Atom className="w-5 h-5 animate-spin" style={{ animationDuration: "3s" }} />
          ...
          >
            <Button
              ...
              className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white px-8 py-3 text-lg rounded-full shadow-lg shadow-cyan-500/25 transform hover:scale-105 transition-all duration-300 border border-cyan-400/50"
            >
            ...
            <Button
              ...
              variant="outline"
              className="border-2 border-purple-500 text-purple-300 hover:bg-purple-500 hover:text-white px-8 py-3 text-lg rounded-full shadow-lg shadow-purple-500/25 transform hover:scale-105 transition-all duration-300 bg-transparent"
            >
      ...
      <section id="contact" className="py-20 relative">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <Button
              className="bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 hover:from-cyan-400 hover:via-blue-400 hover:to-purple-500 text-white px-12 py-4 text-lg rounded-full shadow-lg shadow-cyan-500/25 transform hover:scale-105 transition-all duration-300 border border-cyan-400/50"
